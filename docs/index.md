...
3 frameworks using this approach.

- [Claude Flow](frameworks/claude-flow.md) - SOLID: 3.8/5.0
- [Claude Squad](frameworks/claude-squad.md) - SOLID: 4.0/5.0
- [Claude Swarm / SwarmSDK](frameworks/claude-swarm-swarmsdk.md) - SOLID: 4.1/5.0

### Mcp Native

4 frameworks using this approach.

- [Claude Task Master](frameworks/claude-task-master.md) - SOLID: 4.2/5.0
- [NioPD (Nio Product Director)](frameworks/niopd.md) - SOLID: 3.9/5.0
- [Simone](frameworks/simone.md) - SOLID: 3.6/5.0
- [taskmaster-mcp](frameworks/taskmaster-mcp.md) - SOLID: 4.2/5.0
...
- [systemprompt-orchestrator](frameworks/systemprompt-orchestrator.md) - SOLID: 4.3/5.0
...
- [ClaudeKit](frameworks/claudekit.md)
- [ContextKit](frameworks/contextkit.md)
- [NioPD (Nio Product Director)](frameworks/niopd.md)
- [Simone](frameworks/simone.md)
- [SuperClaude](frameworks/superclaude.md)
- [taskmaster-mcp](frameworks/taskmaster-mcp.md)


## Resources

- [Synthesis](synthesis.md) - Cross-framework analysis
- [Comparisons](comparisons/) - Facet-based comparisons
- [Search](search.html) - Find frameworks
